...
import speechApi.SphixApi
import speechApi.HoundifyApi
import speechApi.IbmApi
import speechApi.WitApi
import speechApi.GoogleApi
import speechApi.AzureApi
...
def duoMainDataset2():
    # amazon ibm duo dataset2
    # checking file 'ibm_amazon_duo_dataset2' exits
    if (os.path.isfile(configs.get("ibm_amazon_duo_dataset2").data)):
        pass
    else:
        # Calling Amazon API
        ...
        print(z)
        # Calling IBM API
        path1 = configs.get("dataset2").data
        y = []
        fname = []
        ...
        with open(configs.get("ibm_amazon_duo_dataset2").data, 'a', newline='') as f:
            writer = csv.writer(f)
    ...
    # google azure duo dataset2
    # Checking file 'google_azure_duo_dataset2' exists or not
    if (os.path.isfile(configs.get("google_azure_duo_dataset2").data)):
        pass
    else:
        # Calling Google and Azure APIs
        path = configs.get("dataset2Converted").data
        with open(configs.get("google_azure_duo_dataset2").data, 'a', newline='') as f:
            writer = csv.writer(f)
    ...
    # wit sphix duo dataset2
    # Checking file 'wit_sphix_duo_dataset2' exits or not
    if (os.path.isfile(configs.get("wit_sphix_duo_dataset2").data)):
        pass
    else:
        # Calling Wit and Sphinx API
        path = configs.get("dataset2Converted").data
        with open(configs.get("wit_sphix_duo_dataset2").data, 'a', newline='') as f:
            writer = csv.writer(f)
    ...
    # azure houndify duo dataset2
    # Checking file 'houndify_azure_duo_dataset2' exits or not
    if (os.path.isfile(configs.get("houndify_azure_duo_dataset2").data)):
        pass
    else:
        # Calling Azure and Houndify API
        path = configs.get("dataset2Converted").data
        with open(configs.get("houndify_azure_duo_dataset2").data, 'a', newline='') as f:
            writer = csv.writer(f)
        ...
        # azure amazon duo dataset2
        # Checking  file 'amazon_azure_duo_dataset2' exits or not
    if (os.path.isfile(configs.get("amazon_azure_duo_dataset2").data)):
        pass
    else:
        # Calling Amazon API
        path = configs.get("aws_s3_dataset2").data
        ...
        print(z)
        # Calling Azure API
        path1 = configs.get("dataset2Converted").data
        y = []
        fname = []
        ...
        with open(configs.get("amazon_azure_duo_dataset2").data, 'a', newline='') as f:
            writer = csv.writer(f)
