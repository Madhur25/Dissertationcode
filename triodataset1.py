...
def trioMainDatset1():
    ...
    wi = []
    fname = []
    # checking file 'google_ibm_wit_trio_dataset1' exits
    if (os.path.isfile(configs.get("google_ibm_wit_trio_dataset1").data)):
        pass
    else:
        # Calling Google API
        ...
        print(fname)
        # Calling IBM API
        path = configs.get("dataset1").data
        ...
        with open(configs.get("google_ibm_wit_trio_dataset1").data, 'a', newline='') as f:
            writer = csv.writer(f)
    ...
    # checking file 'amazon_azure_houndify_trio_dataset1' exits
    if (os.path.isfile(configs.get("amazon_azure_houndify_trio_dataset1").data)):
        pass
    else:
        # Creating lists to store the results from different APIs
        az = []
        ...
        print(fname)
        # writing the all three APIs into file
        with open(configs.get("amazon_azure_houndify_trio_dataset1").data, 'a', newline='') as f:
            writer = csv.writer(f)
    ...
    # checking file 'sphinx_azure_houndify_trio_dataset1' exits
    if (os.path.isfile(configs.get("sphinx_azure_houndify_trio_dataset1").data)):
        pass
    else:
        ...
        print(fname)
        # writing the all three APIs into file
        with open(configs.get("sphinx_azure_houndify_trio_dataset1").data, 'a', newline='') as f:
            writer = csv.writer(f)
 ...
 # amazon,azure,google trio ensemble method
    # checking file 'amazon_azure_google_trio_dataset1' exits
    if (os.path.isfile(configs.get("amazon_azure_google_trio_dataset1").data)):
        pass
    else:
        # creating list to store the results from different APIs
        az2 = []
        ...
        print(fname)
        # writing the all three APIs into file
        with open(configs.get("amazon_azure_google_trio_dataset1").data, 'a', newline='') as f:
            writer = csv.writer(f)
